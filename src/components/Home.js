      ...
      <div className="ContainerHalfway">
        <div className="ContainerRow">
          <div className="ContainerColumn">
            <img
              src="https://www.freepnglogos.com/uploads/pokemon-png/pokemon-png-transparent-pokemon-images-pluspng-19.png"
              width="300"
              alt="pokemon png transparent pokemon images pluspng"
            />
            <Link to="/search">
              <button
